...
授業内容に関わる疑問は，原則，授業支援システムのフォーラムやチャットを利用してください。公共性の高い質問をされた方には，ボーナスポイントがあります。ただし，小テストの解答について疑義がある等，他の学生の受験状況に影響があると考えられる質問は，メールや LINE のチャットを利用してください。
...
LINE公式アカウントの ID: [@kjst](https://lin.ee/abGbNBI)

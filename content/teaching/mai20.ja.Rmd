...
授業内容に関わる疑問は，原則，LINEオープンチャットを利用してください  (授業支援システムにリンクを掲載)。公共性の高い質問をされた方には，ボーナスポイントがあります。ただし，小テストの解答について疑義がある等，他の学生の受験状況に影響があると考えられる質問はメールや LINE（[@kjst](https://lin.ee/abGbNBI)） のチャットを利用してください。
